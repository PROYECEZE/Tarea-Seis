...
export default function Post() {
  ...
  <>
    ...
    <main className="container px-8 py-10 max-w-dimensions sm:py-24 sm:px-0 font-roboto">
      <h1 className="text-center text-2xl font-bold text-lighBlack sm:text-43px"> Should I work remotely or will it put a strain on my long-term career?</h1>
      <p className="mt-6 text-base sm:text-postSubtitle text-darkBlue font-black text-center">As part of our ongoing effort to enhance the traveler journey, we're proud to partner with Portland International Airport (PDX) on the launch of a pilot program designed to shorten rider wait times at pickup. </p>
      <div className="my-10 sm:my-20 flex items-center gap-10 justify-between">
        <div className="flex items-center">
          <img src="images/women.png" alt="Alice Cooper" className="w-9 h-auto"/>
          <div className="ml-3">
            <p className="font-semibold text-gray-900 text-xs tracking-wider font-black text-lighBlack">ALICE COOPER</p>
            <p className="mt-0.5 text-sm text-darkBlue font-black opacity-70 text-xs">Published on May 20, 2019</p>
          </div>
        </div>
      ...
      <div className="mt-8">
        <img src="images/works.png" alt="Person looking at wall with photos" width="800" height="400"/>
