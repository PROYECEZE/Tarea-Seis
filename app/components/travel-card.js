...
export default function TravelCard({ id, imageUrl, priceColor, price, title, abstract, authorUrl, authorBlog, published}) {
  return (
    <div className="rounded-lg bg-white shadow-sm transition-shadow hover:shadow-md relative">
      ...
      <div className="p-6">
        ...
        <button type="button" className="block ml-auto mb-2 group relative" aria-label="add favorite">
          <svg className="text-intenseGray group-hover:text-intenseYellow transition-colors duration-300" width="16" height="16" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
